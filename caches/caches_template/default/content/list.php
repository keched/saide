...
<div class="main">
    ...
    <div class="fr right">
		...
		<div class="page-tab"><div class="page-tab"><span class="pg-tab"><a href="<?php echo $CATEGORYS['39']['url'];?>">公司新闻</a></span>|<span><a href="<?php echo $CATEGORYS['40']['url'];?>">行业资讯</a></span></div></div>
        <div class="clear"></div>
        <div class="news">
        	<div class="news-top">
